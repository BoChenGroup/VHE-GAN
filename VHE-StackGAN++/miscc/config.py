...
__C.TRAIN.MLPENCODER_LR = 2e-3
__C.TRAIN.NET_G = ''
__C.TRAIN.NET_D = ''
__C.TRAIN.NET_MLP_IMG = ''
__C.TRAIN.NET_MLP_TXT = ''
__C.TRAIN.NET_MLP_MERGE = ''

__C.TRAIN.COEFF = edict()
__C.TRAIN.COEFF.UNCOND_LOSS = 0.0
__C.TRAIN.COEFF.KL_theta1_LOSS = 0.0
